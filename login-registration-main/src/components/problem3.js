    ...
    <body id="page12">
      <div className="container">
        ...
        {!showMenu ? (
          ...
          Write a function of Stack using Doubly Linked List
          </h2>
          <p className="description">
          1. push() : Insert the element into Stack and assign the top pointer to
            the element.<br></br> 2. pop() : Return top element from the Stack and move
            the top pointer to the second element of the Stack.</p>
        </div>
          ) : (
            <div className="menu">
              <h2>Result</h2>
